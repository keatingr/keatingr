...
<details>
<summary>(expand) The ASR feature embedded in production iOS and web...</summary>
... demonstrates client audio capture, push-to-talk workflows, WebSocket streaming, and private GPU-backed inference. Additional R&D was completed for speaker diarization, noise cancellation and handsfree intent decomposition and routing, however were not selected for production release.
